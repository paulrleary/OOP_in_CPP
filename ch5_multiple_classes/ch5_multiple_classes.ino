...
Sweeper sweeper1(9, 10, 1, 0); //Instantiates an instance of Sweeper class, creating an object (of type Sweeper) called sweeper1(int pin, int interval, int increment, bool printflag)
